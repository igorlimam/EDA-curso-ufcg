...
\hypersetup{
  pdftitle={BoJack Hoseman e os feels},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bojack =}\StringTok{ }\NormalTok{series }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(series_name}\OperatorTok{==}\StringTok{"BoJack Horseman"}\NormalTok{)}
\NormalTok{bojack }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ series_ep,}\DataTypeTok{y =}\NormalTok{ UserVotes,}\DataTypeTok{color =} \KeywordTok{as.factor}\NormalTok{(season)))}\OperatorTok{+}
\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \DecValTok{2}\NormalTok{)}\OperatorTok{+}
\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{bojack_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{bojack =}\StringTok{ }\NormalTok{series }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(series_name}\OperatorTok{==}\StringTok{"BoJack Horseman"}\NormalTok{)}
\NormalTok{bojack }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\DataTypeTok{mapping =} \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ series_ep,}\DataTypeTok{y =}\NormalTok{ UserRating,}\DataTypeTok{color =} \KeywordTok{as.factor}\NormalTok{(season)))}\OperatorTok{+}
\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{size =} \DecValTok{2}\NormalTok{)}\OperatorTok{+}
\KeywordTok{geom_line}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{bojack_files/figure-latex/unnamed-chunk-2-1.pdf}
